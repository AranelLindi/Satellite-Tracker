...
// eigener Code
#include "GregorianCalendar.h"                 // GregorianCalendar-Objekt
#include "Orbitpropagation/orbitpropagation.h" // Calendar-Funktionen
#include "sat_calculation.h"                   // (Aufgabe 3.1)
#include "position.h"                          // Operator-Overloading für GregorianCalendar
